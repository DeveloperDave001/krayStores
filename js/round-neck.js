const productImages = [
  'round-neck-img/download (5).webp',
  'round-neck-img/Ice Silk Round Neck T-Shirt.jpg',
  'round-neck-img/Simple T-Shirt.jpg',
  'round-neck-img/2025 Summer New 3D striped letter Print Men\'s Casual short-sleeved T-shirt and shorts Set Adult.jpg',
  'round-neck-img/Arabic _Salam_ Calligraphy T-Shirt.jpg',
  'round-neck-img/Camiseta de manga curta de gola redonda minimalista casual para adolescentes.jpg',
  'round-neck-img/Camiseta Estampada Geométrico Hombre - Temu Mexico.jpg',
  'round-neck-img/camiseta masculina de verão casual manga - Temu Brazil.jpg',
  'round-neck-img/Casual Simple New York English Graphic Round Neck Short Sleeve Fitted Plus Size Women\'s T-Shirt, Summer.jpg',
  'round-neck-img/download (29).jpg',
  'round-neck-img/download (30).jpg',
  'round-neck-img/download (31).jpg',
  'round-neck-img/download (32).jpg',
  'round-neck-img/download (33).jpg',
  'round-neck-img/download (34).jpg',
  'round-neck-img/download (35).jpg',
  'round-neck-img/download (36).jpg',
  'round-neck-img/download (37).jpg',
  'round-neck-img/download (38).jpg',
  'round-neck-img/FAITH ON _ FEAR OFF _ Premium Unisex Christian T-shirt - L.jpg',
  'round-neck-img/Fly ✈️.jpg',
  'round-neck-img/In The Waiting God is Working SVG _ Encouragement Christian SVG File.jpg',
  'round-neck-img/Manfinity Homme Men\'s Loose Slogan Printed Round Neck Sweatshirt.jpg'
];
const getProductImage = (id) => productImages[(id - 1) % productImages.length];
const PRODUCTS = [
  {id:1,name:"Classic White Round Neck",short:"Timeless white round neck tee. Premium cotton for everyday comfort.",price:18.00,oldPrice:null,weight:null,category:"basic",goals:["casual","essential"],tags:["White","Basic","Cotton"],badge:"best",rating:4.9,reviews:142,featured:true,newest:false},
  {id:2,name:"Black Slim Fit Round Neck",short:"Sleek black slim fit. Perfect for layering.",price:22.00,oldPrice:null,weight:null,category:"slim",goals:["formal","casual"],tags:["Black","Slim Fit","Men"],badge:null,rating:4.8,reviews:98,featured:true,newest:false},
  {id:3,name:"Navy Blue Polo Neck",short:"Classic navy polo with collar. Smart casual option.",price:26.00,oldPrice:null,weight:null,category:"polo",goals:["formal","casual"],tags:["Polo","Navy","Men"],badge:null,rating:5.0,reviews:76,featured:true,newest:false},
  {id:4,name:"Grey Oversized Round Neck",short:"Comfortable oversized fit. Relaxed weekend vibe.",price:25.00,oldPrice:null,weight:null,category:"oversized",goals:["casual","summer"],tags:["Grey","Oversized","Unisex"],badge:"new",rating:4.9,reviews:53,featured:true,newest:true},
  {id:5,name:"Pocket Detail Round Neck",short:"Stylish chest pocket detail. Functional and trendy.",price:24.00,oldPrice:null,weight:null,category:"pocket",goals:["casual","sports"],tags:["Pocket","Trendy","Unisex"],badge:null,rating:4.7,reviews:41,featured:true,newest:false},
  {id:6,name:"Burgundy V-Neck",short:"Rich burgundy V-neck. Elevates any outfit.",price:28.00,oldPrice:null,weight:null,category:"vneck",goals:["formal","winter"],tags:["Burgundy","V-Neck","Men"],badge:"best",rating:4.8,reviews:88,featured:true,newest:true},
  {id:7,name:"Beige Basic Round Neck",short:"Neutral beige essential. Versatile wardrobe staple.",price:19.00,oldPrice:null,weight:null,category:"basic",goals:["casual","essential"],tags:["Beige","Basic","Essential"],badge:null,rating:4.9,reviews:67,featured:false,newest:true},
  {id:8,name:"Striped Polo Neck",short:"Classic striped polo. Preppy and stylish.",price:30.00,oldPrice:null,weight:null,category:"polo",goals:["formal","casual"],tags:["Striped","Polo","Men"],badge:null,rating:4.8,reviews:92,featured:false,newest:false},
  {id:9,name:"Ice Silk Slim Fit",short:"Cooling ice silk fabric. Summer essential.",price:27.00,oldPrice:null,weight:null,category:"slim",goals:["summer","sports"],tags:["Ice Silk","Cooling","Men"],badge:null,rating:4.9,reviews:54,featured:false,newest:true},
  {id:10,name:"Black Basic Round Neck",short:"Essential black tee. Every wardrobe needs this.",price:18.00,oldPrice:null,weight:null,category:"basic",goals:["casual","essential"],tags:["Black","Basic","Essential"],badge:null,rating:4.7,reviews:45,featured:false,newest:false},
  {id:11,name:"Limited Edition V-Neck",short:"Exclusive V-neck design. Limited drop.",price:32.00,oldPrice:null,weight:null,category:"vneck",goals:["formal","casual"],tags:["Limited","Exclusive","Unisex"],badge:"new",rating:4.8,reviews:76,featured:false,newest:true},
  {id:12,name:"Summer Light Round Neck",short:"Breathable lightweight fabric. Perfect for summer.",price:21.00,oldPrice:null,weight:null,category:"basic",goals:["summer","sports"],tags:["Lightweight","Summer","Unisex"],badge:null,rating:4.6,reviews:38,featured:false,newest:true},
  {id:13,name:"Slim Fit Polo Neck",short:"Tailored slim fit polo. Sharp and professional.",price:28.00,oldPrice:null,weight:null,category:"polo",goals:["formal","business"],tags:["Slim Fit","Polo","Men"],badge:null,rating:4.8,reviews:62,featured:false,newest:false},
  {id:14,name:"Plus Size Oversized Tee",short:"Comfortable plus size oversized fit.",price:26.00,oldPrice:null,weight:null,category:"oversized",goals:["casual","summer"],tags:["Plus Size","Oversized","Unisex"],badge:null,rating:4.9,reviews:89,featured:false,newest:false},
  {id:15,name:"White V-Neck Classic",short:"Crisp white V-neck. Clean and versatile.",price:23.00,oldPrice:null,weight:null,category:"vneck",goals:["formal","casual"],tags:["White","V-Neck","Men"],badge:null,rating:4.7,reviews:112,featured:false,newest:false},
  {id:16,name:"Pocket Henley Round Neck",short:"Henley style with pocket. Casual sophistication.",price:29.00,oldPrice:null,weight:null,category:"pocket",goals:["casual","winter"],tags:["Henley","Pocket","Men"],badge:null,rating:4.8,reviews:95,featured:false,newest:false},
  {id:17,name:"Winter Thermal Round Neck",short:"Warm thermal fabric. Cold weather essential.",price:32.00,oldPrice:null,weight:null,category:"basic",goals:["winter","essential"],tags:["Thermal","Winter","Men"],badge:null,rating:4.7,reviews:58,featured:false,newest:true},
  {id:18,name:"Graphic Pocket Tee",short:"Subtle graphic on pocket. Minimalist style.",price:25.00,oldPrice:null,weight:null,category:"pocket",goals:["casual","sports"],tags:["Graphic","Pocket","Unisex"],badge:null,rating:4.6,reviews:42,featured:false,newest:false},
  {id:19,name:"Olive Green Round Neck",short:"Earthy olive tone. Nature-inspired style.",price:22.00,oldPrice:null,weight:null,category:"basic",goals:["casual","essential"],tags:["Olive","Basic","Unisex"],badge:null,rating:4.9,reviews:67,featured:false,newest:false},
  {id:20,name:"Performance Polo Neck",short:"Sweat-wicking polo. Perfect for sports.",price:35.00,oldPrice:null,weight:null,category:"polo",goals:["sports","summer"],tags:["Performance","Polo","Men"],badge:null,rating:4.8,reviews:74,featured:false,newest:true},
  {id:21,name:"Pure Cotton White Tee",short:"100% pure cotton. Ultimate comfort.",price:20.00,oldPrice:null,weight:null,category:"basic",goals:["casual","essential"],tags:["Pure Cotton","White","Essential"],badge:null,rating:4.9,reviews:156,featured:false,newest:false},
  {id:22,name:"Maroon V-Neck",short:"Deep maroon V-neck. Rich and sophisticated.",price:26.00,oldPrice:null,weight:null,category:"vneck",goals:["formal","winter"],tags:["Maroon","V-Neck","Men"],badge:null,rating:4.8,reviews:134,featured:false,newest:false},
  {id:23,name:"Athletic Slim Fit",short:"Performance slim fit. Built for movement.",price:29.00,oldPrice:null,weight:null,category:"slim",goals:["sports","summer"],tags:["Athletic","Slim Fit","Men"],badge:null,rating:4.7,reviews:78,featured:false,newest:false},
  {id:24,name:"Winter Oversized Tee",short:"Cozy oversized fit. Winter layering essential.",price:30.00,oldPrice:null,weight:null,category:"oversized",goals:["winter","essential"],tags:["Winter","Oversized","Unisex"],badge:null,rating:4.8,reviews:92,featured:false,newest:false},
];
...
const tagColors = {'White':'ptag-g','Basic':'ptag-g','Cotton':'ptag-g','Black':'ptag-g','Slim Fit':'ptag-b','Men':'ptag-b','Polo':'ptag-a','Navy':'ptag-b','Grey':'ptag-g','Oversized':'ptag-b','Unisex':'ptag-b','Pocket':'ptag-a','Trendy':'ptag-b','Burgundy':'ptag-p','V-Neck':'ptag-a','Beige':'ptag-g','Essential':'ptag-g','Striped':'ptag-b','Ice Silk':'ptag-p','Cooling':'ptag-a','Lightweight':'ptag-a','Summer':'ptag-a','Performance':'ptag-p','Limited':'ptag-r','Exclusive':'ptag-p','Olive':'ptag-g','Athletic':'ptag-b','Maroon':'ptag-p','Winter':'ptag-a','Thermal':'ptag-p','Henley':'ptag-a'};
